    ...
    return (
        ...
        <div className="absolute p-6 w-[250px] bg-[#1D1F22] h-full justify-between flex  flex-col">
            <div className="flex items-center flex-col">
                ...
                <div className="new-document bg-[#E46643] h-10 w-[202px] mt-[29px] rounded-[4px] flex justify-center items-center">
                    <p className="text-white text-[15px] font-normal leading-normal">+ New Document</p>
                </div>

                <div className="flex gap-4 float-left mt-6 ml-[-50px]">
                    <div className="flex items-center">
                        <img src="./icon-document.svg" alt="document" />
                    </div>
                    <div className="flex flex-col gap-[3px] ">
                        <p className="text-[#7C8187] text-[13px] font-light leading-normal">01 April 2022</p>
                        <p className="text-white text-[15px] font-normal leading-normal ">untitled-document</p>
                    </div>
                </div>
